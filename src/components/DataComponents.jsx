...
export const DataComponent = () => {
    ...
    <div className="ml-[10px] mt-[70px] md:flex flex items-start justify-end md:mb-[30px]">
        <div className="w-[1px] md:mt-[30px] sm:mt-[30px] mt-[5px] h-[50px] sm:h-[62px] bg-[#7A7A7A] mr-[19px]"></div>
        <div className="flex flex-col sm:flex sm:flex-col gap-3 sm:gap-4 w-[60px] h-[60px] sm:w-[70px] sm:h-[100px] sm:pt-4  md:mr-[40px]">
        ...
        <div className="w-[1px] md:mt-[30px] sm:mt-[30px] mt-[5px] h-[50px] sm:h-[62px] bg-[#7A7A7A] mr-[19px]"></div>
        <div className="flex flex-col sm:flex sm:flex-col gap-3 sm:gap-4 w-[55px] h-[60px] sm:w-[70px] sm:h-[100px] sm:pt-4 md:mr-[40px]">
        ...
        <div className="w-[1px] md:mt-[30px] sm:mt-[30px] mt-[5px] h-[50px] sm:h-[62px] bg-[#7A7A7A] mr-[19px]"></div>
        <div className="flex flex-col sm:flex sm:flex-col gap-3 sm:gap-4 w-[60px] h-[60px] sm:w-[70px] sm:h-[100px] sm:mr-[30px] sm:pt-4 md:mr-[40px]">
        ...
        <div className="w-[1px] md:mt-[30px] sm:mt-[30px] mt-[5px] h-[50px] sm:h-[62px] bg-[#7A7A7A] mr-[19px]"></div>
        <div className="flex flex-col sm:flex sm:flex-col gap-3 sm:gap-4 w-[60px] h-[60px] sm:w-[70px] sm:h-[100px] sm:pt-4 sm:mr-[60px] lg:mr-[150px]">
